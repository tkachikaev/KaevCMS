...
Bundled version: **1.5.1** for KaevCMS **0.44.28+**. Usage and text limits are configured by Owner in the module settings and retain safe defaults.

Встроенная версия: **1.5.1** для KaevCMS **0.44.28+**. Лимиты обращений и длины текста настраиваются владельцем в настройках модуля; безопасные значения по умолчанию сохранены.
