...
<nav class="admin-tabs settings-section-tabs support-settings-tabs" aria-label="{{ __('module-support-tickets::messages.settings_sections') }}" data-testid="support-settings-tabs">
    <a
        wire:navigate
        @class(['admin-tab', 'settings-section-tab', 'active' => $activeTab === 'general'])
    ...
    <a
        wire:navigate
        @class(['admin-tab', 'settings-section-tab', 'active' => $activeTab === 'cleanup'])
        href="{{ route('admin.module-pages.support-tickets.settings', ['adminPath' => $adminPath, 'tab' => 'cleanup']) }}"
        @if($activeTab === 'cleanup') aria-current="page" @endif
    >
...
@else
    <section class="form-card settings-narrow-card support-cleanup-card" data-testid="support-cleanup-panel">
        <div class="settings-card-heading">
            <div>
