...
Route::get('/items/{server}/{item}', [AdminPromoCodeController::class, 'itemPreview'])
    ->whereNumber(['server', 'item'])
...
Route::patch('/{promoCode}/restore', [AdminPromoCodeController::class, 'restore'])->whereNumber('promoCode')->name('restore');
