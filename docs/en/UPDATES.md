...
The public cumulative line starts at `0.42.4`. The `KaevCMS-cumulative-update-0.42.4-0.44.5-to-0.44.6.zip` package updates supported releases from 0.42.4 through 0.44.5 directly to 0.44.6.
