...
Web Installer разрешает установку как по HTTPS, так и по HTTP. При незашифрованном соединении он показывает одно заметное предупреждение, но не блокирует проверку MySQL, создание владельца или завершение установки.
