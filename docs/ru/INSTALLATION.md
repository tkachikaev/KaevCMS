...
6. После успешной установки Web Installer автоматически удаляет публичную папку `/install`. Если итоговая страница сообщает об ошибке удаления, удалите каталог вручную перед открытием сайта пользователям.
