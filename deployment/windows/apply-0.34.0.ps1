...
$requiredFiles = @(
    ...
    'public\game-assets\items\.gitkeep'
    'public\game-assets\items\interlude\.gitkeep'
    'public\game-assets\characters\classic\human\female\.gitkeep'
    'public\game-assets\characters\high-five\human\female\.gitkeep'
    'public\game-assets\characters\shine-maker\human\female\.gitkeep'
