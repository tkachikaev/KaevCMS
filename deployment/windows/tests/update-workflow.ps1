...
try {
    ...
    Assert-True ($updateScript.Contains("$recoverableFromVersions = @('0.34.9', '0.35.0', '0.36.0', '0.36.1')")) 'Updater does not recover an interrupted 0.35.0 update from 0.34.9.'
    Assert-True ($updateScript.Contains("$supersededPendingTargets = @('0.35.0', '0.36.0', '0.36.1', '0.36.2')")) 'Updater does not adopt the interrupted 0.35.0 pending target.'
    ...
    $applyScript = Get-Content -LiteralPath "$PSScriptRoot\..\apply-0.36.2.ps1" -Raw
