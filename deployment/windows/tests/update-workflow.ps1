...
Assert-True ($obsoleteArtifacts -notcontains (ConvertTo-KaevCmsPlatformPath -Path 'public/install')) 'The Windows development update workflow must preserve the public installer required by release quality tests.'
